...
router.get("/api/controle-asbuilt/colunas", verificarToken, autorizar("medicao.controle_asbuilt.visualizar", "medicao.controle_asbuilt.editar"), controleAsbuilt.listarColunas);
...
router.post("/api/controle-asbuilt/colunas", verificarToken, autorizar("medicao.controle_asbuilt.editar"), controleAsbuilt.criarColuna);
router.put("/api/controle-asbuilt/colunas/:campo", verificarToken, autorizar("medicao.controle_asbuilt.editar"), controleAsbuilt.atualizarColuna);
router.delete("/api/controle-asbuilt/colunas/:campo", verificarToken, autorizar("medicao.controle_asbuilt.editar"), controleAsbuilt.excluirColuna);
